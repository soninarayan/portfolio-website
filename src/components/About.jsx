        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/soninarayan/", "_blank")}
            >
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/soninarayan", "_blank")}
            >
...
>
  <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.1, 0.75)}>
    ...
    <span>
      I’m a Software Developer and Cloud Engineer specializing in building scalable, distributed systems using AWS, Node.js, React, and Spring Boot.
    </span>
  </motion.li>
  <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
    <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
    <span>
      I'm currently pursuing my M.S. in Computer Science at the University of Houston, with a 4.0 GPA.
    </span>
  </motion.li>
  <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.3, 0.75)}>
    <span className="mr-4 text-2xl flex-shrink-0">⚙️</span>
    <span>
      I've worked with startups and universities to build mentor platforms, data pipelines, and AI-powered geospatial tools — all production-grade.
    </span>
  </motion.li>
  <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.4, 0.75)}>
    <span className="mr-4 text-2xl flex-shrink-0">🚀</span>
    <span>
      I love turning ideas into scalable apps, optimizing backend performance, and automating delivery with CI/CD.
    </span>
  </motion.li>
  <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.5, 0.75)}>
    <span className="mr-4 text-2xl flex-shrink-0">📚</span>
    <span>
      I'm always learning — currently diving deeper into system design and distributed architectures.
    </span>
  </motion.li>
</motion.ul>
        </motion.div>
