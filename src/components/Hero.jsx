      ...
      <div className={`absolute inset-0 top-[120px] max-w-7xl mx-auto ${styles.paddingX} flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#915EFF]">Narayan</span> <WavingHand />
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Houston-based Engineer passionate about scalable systems. <br />
            I'm a <TypewriterText texts={typedItems} /> <br />
            <b>Welcome to my portfolio — best viewed on desktop!</b>
          </p>
        </div>
      </div>
